...
import { PortfolioSectionModel, IPortfolioSection } from "../../model/portfolioSectionModel";
import { IPortfolioRepository } from "../interface/IPortfolioRepository";

export class PortfolioRepository extends BaseRepository<IPortfolioSection> implements IPortfolioRepository {
    constructor() {
