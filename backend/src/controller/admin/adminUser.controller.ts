...
export class AdminController implements IAdminController {
  ...
  getAllUser = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const result = await this._adminService.getAllUser(queryInput);
  ...
  getUser = async (req: Request, res: Response): Promise<void> => {
    try {
      const { id } = req.params;
      const user = await this._adminService.getUser(id);
  ...
  blockUser = async (req: Request, res: Response): Promise<void> => {
    try {
      const { id } = req.params;
      const user = await this._adminService.blockUser(id);
