...
export const getPhotographerRecommendations = async (
  ...
  try {
    ...
    // Fetch photographers
    const photographers = await PhotographerModel.find(filter)
      .limit(limit)
      .lean();
...
export const formatPhotographerRecommendations = (
  ...
  response += "Would you like to see more details about any of these photographers, or would you like me to help you refine your search?";
...
export const extractUserPreferences = (
  ...
  if (
    ...
    preferences.location = allText.includes("new york") || allText.includes("ny")
      ? "New York"
      : "Los Angeles";
    preferences.hasPreferences = true;
  }
